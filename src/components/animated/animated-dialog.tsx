...
type DialogContentProps = {
    ...
    className?: string;
    style?: React.CSSProperties;
    onClose?: () => void; // Add onClose callback prop
  };
  
  function DialogContent({ children, className, style, onClose }: DialogContentProps) {
...
type DialogCloseProps = {
  ...
  function DialogClose({ children, className, variants, onClose }: DialogCloseProps) {
